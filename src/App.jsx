...
function App() {
  ...
  return (
    <>
      ...
      rounded-lg px-4 my-8 text-orange-500 bg-gray-700 text-orange-500'>
        <h1 className='text-white text-center my-3'>Passowrd Genrator</h1>
        ...
        <div className='flex text-sm gap-x-2'>
          ...
          <div className='flex item-center gap-x-1'>
            ...
            />
            <lable htmlFor="characterInput">CharacterInput</lable>
          </div>
        </div>
